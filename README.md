...
* 🐍 **Python**: Асинхронная разработка, API на **FastAPI** (любимый фреймворк), проекты на Django/Flask, Telegram-боты на **aiogram**.
* 🐘 **Базы данных**: Основной выбор — **PostgreSQL** (также работал с MySQL и MS SQL Server).
* 🌐 **C# / .NET**: Изучение веб-разработки на **ASP.NET Core**.
* 🦀 **Rust**: Чтение *RustBook* и освоение концепций языка.
